...
export type LaunchQuery = {
  launch: Maybe<
    { __typename?: 'Launch' } & Pick<Launch, 'id' | 'mission_name' | 'launch_date_local'> & {
        rocket: Maybe<{ __typename?: 'LaunchRocket' } & Pick<LaunchRocket, 'rocket_name'>>
        links: Maybe<{ __typename?: 'LaunchLinks' } & Pick<LaunchLinks, 'video_link'>>
      }
  >
}
...
export type LaunchesQuery = {
  launchesPast: Maybe<
    Array<
      Maybe<
        { __typename?: 'Launch' } & Pick<Launch, 'id' | 'mission_name'> & {
            rocket: Maybe<{ __typename?: 'LaunchRocket' } & Pick<LaunchRocket, 'rocket_name'>>
          }
      >
    >
...
export const LaunchesDocument = gql`
  query Launches($limit: Int!) {
    launchesPast(limit: $limit, order: "launch_date_local") {
      id
      mission_name
      rocket {
        rocket_name
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Launch(
      variables: LaunchQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<LaunchQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<LaunchQuery>(LaunchDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Launch'
    ...
    Launches(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<LaunchesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<LaunchesQuery>(LaunchesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Launches'
